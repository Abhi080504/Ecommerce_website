...
import { Add, Dashboard, Inventory, ShoppingBag, AccountBalanceWallet, Receipt, AccountBox, Logout } from '@mui/icons-material'
...
const menu = [
            ...
            name: "Dashboard",
            path: "/seller",
            icon: <Dashboard className="Otext-primary-color" />,
