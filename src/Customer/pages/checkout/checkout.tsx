...
const paymentGatwayList=[
    ...
    {
        value:"STRIPE",
        image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZFgNCm9j7xOAEE7DfXCwvgm-Uqyla4ILe6A&s",
        label:""
    }
]
  ...
  return (
    <>
      <div className="pt-10 px-5 sm:px-10 md:px-44 lg:px-60 min-h-screen">
        <div className="space-y-5 lg:space lg:grid grid:cols-3 lg:gap-9">
